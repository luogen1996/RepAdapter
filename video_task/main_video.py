...
def main(args):
    ...
    adapter_num = sum(p.numel() for n, p in model.named_parameters() if 'rep' in n and p.requires_grad)
    params = {'Total': total_num, 'Trainable': trainable_num, 'Adapter': adapter_num}
    print(params)
